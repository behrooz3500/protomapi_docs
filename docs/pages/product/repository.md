...
r = requests.post('http://domain/api/repositories', json=data)</code></pre>
</div>
</div>
...
<table>
    ...
    <h3>Example 1:</h3>
<pre><code>r = requests.get('http://domain/api/repositories')</code></pre>
...
r = requests.get('http://domain/api/repositories', params=params)</code></pre>
</div>
</div>
...
<pre><code>r = requests.get('http://domain/api/repositories/66')</code></pre>
</div>
</div>
...
r = requests.put('http://domain/api/repositories/66', json=data)</code></pre>
</div>
</div>
...
<pre><code>r = requests.delete('http://domain/api/repositories/66')</code></pre>
</div>
</div>
